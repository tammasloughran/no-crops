...
plt.savefig('plots/cLand_10pct_australia.png', dpi=200)
plt.figure()
plot_australia(maps['GWL-25pct-B2030'] - maps['PI-GWL-t6'], title='25%')
plt.savefig('plots/cLand_25pct_australia.png', dpi=200)
plt.figure()
plot_australia(maps['GWL-50pct-B2030'] - maps['PI-GWL-t6'], title='50%')
plt.savefig('plots/cLand_50pct_australia.png', dpi=200)
