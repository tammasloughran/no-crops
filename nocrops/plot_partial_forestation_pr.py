...
for exper in EXPERIMENTS:
    ...
    files = sorted(glob.glob(f'{ARCHIVE_DIR}/{exper}/pr_*'))
...
plt.xlabel('Year')
plt.savefig('plots/pr_partial_forestation.png', dpi=200)
