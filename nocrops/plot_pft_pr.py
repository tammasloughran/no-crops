...
def plot_australia(data:np.ndarray, title:str)->None:
    """Plot a map of Asutralia precipitation anomalies.
    """
...
plt.savefig('plots/pr_EGBL_australia.png', dpi=200)
plt.figure(6)
plot_australia(maps['GWL-EGNL-B2030'] - maps['PI-GWL-t6'], 'Evergreen needleleaf')
plt.savefig('plots/pr_EGNL_australia.png', dpi=200)
plt.figure(7)
plot_australia(maps['GWL-DCBL-B2030'] - maps['PI-GWL-t6'], 'Deciduous broadleaf')
plt.savefig('plots/pr_DCBL_australia.png', dpi=200)
